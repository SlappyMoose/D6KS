...
formSquare = {index = 4, click_function = "nullFunction", function_owner = self, label = "□", position = {0, 0.26, 0.1}, rotation = {0, 0, 0}, scale = {4, 4, 4}, width = 150, height = 150, font_size = 250, font_color = {1,1,1,127}, color = {0,0,0,0}}
...
urlLine = "https://steamusercontent-a.akamaihd.net/ugc/10112965672199200806/78EC74BF460FF6961D17230D12F905043173F8B2/"
urlColumn = "https://steamusercontent-a.akamaihd.net/ugc/1831276854756596511/F61CFC2CFA4695933F57DB734B50A4C1FB87694A/"

function CreateFormationOverlay()
	-- print("Starting CreateFormationOverlay...")
	-- printDebug()
	...
	-- print("Finished CreateFormationOverlay.")
	-- printDebug()
end
...
function updateForm()
	...
	if currentForm == 1 then
		...
		if FormationOverlay ~= nil then else CreateFormationOverlay() end
	else
		self.editButton({index = 5, label = "L", font_color = 'White', tooltip = "Form Line"})
		RemoveFormationOverlay()
